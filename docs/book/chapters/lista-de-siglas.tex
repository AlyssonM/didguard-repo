...
\begin{description}[
  ...
  \item[API] Interface de programacao de aplicacoes
  ...
  \item[ESP32] Plataforma de microcontrolador com Wi-Fi da Espressif
  ...
  \item[MAC] Codigo de autenticacao de mensagem
  \item[MFRC522] Leitor RFID MFRC522 da NXP
  \item[MIFARE] Familia de cartoes e tags sem contato da NXP
